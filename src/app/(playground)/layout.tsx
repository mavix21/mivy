...
export default function RootLayout({
  ...
  return (
    <div className="size-full flex flex-col">
      <header className="font-mono border-b border-black">
        <div className="flex flex-col gap-2 w-full">
          <div className="flex flex-row gap-2 text-xl font-bold items-center justify-center">
            ...
            <h2>
              ...
              ,{" "}
              <Link href="https://vercel.com/ai-gateway" className="underline">
                AI Gateway
              </Link>
              ,{" "}
              <Link
              ...
              , and the{" "}
              <Link href="https://docs.cdp.coinbase.com/" className="underline">
                Coinbase CDP
              </Link>
            </h2>
          </div>
